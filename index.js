...
client.on('ready', () => {
  ...
  client.user.setActivity(`xlhelp | xlinvite for bot invite.`, { type: "WATCHING"}).catch(console.error)
...
client.login("ODA4MjEzNjA0MDg4MTUyMDc0.YCDRkw.oAe8OCiEavtrtE0SD75aGUN4u4g")
